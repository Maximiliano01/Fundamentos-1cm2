...
${OBJECTDIR}/fibonacci\ recursividad.o: fibonacci\ recursividad.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fibonacci\ recursividad.o fibonacci\ recursividad.c
...
${OBJECTDIR}/hanoi.o: hanoi.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hanoi.o hanoi.c
...
${OBJECTDIR}/promedio\ con\ archivos.o: promedio\ con\ archivos.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/promedio\ con\ archivos.o promedio\ con\ archivos.c
